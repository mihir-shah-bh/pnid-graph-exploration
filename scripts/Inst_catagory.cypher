...
CREATE (valve_1:Valve {name: 'Valve 1'})
CREATE (valve_2:Valve {name: 'Valve 2'})
CREATE (indicator:Indicator {name: 'Indicator'})
CREATE (dcs:DCS {name: 'DCS'})
CREATE (process:Process {name: 'Process'})
CREATE (valve_1)-[:PIPE]->(indicator)
CREATE (valve_2)-[:SOFTWARE]->(dcs)
CREATE (valve_2)-[:SOFTWARE]->(process)
